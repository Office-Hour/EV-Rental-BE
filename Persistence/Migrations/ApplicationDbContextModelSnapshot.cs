...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Implement.Aggregates.Identity_KyC.Document", b =>
                {
                    ...
                    b.HasIndex("BackImageId")
                        .IsUnique()
                        .HasFilter("[BackImageId] IS NOT NULL");

                    b.HasIndex("FrontImageId")
                        .IsUnique()
                        .HasFilter("[FrontImageId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Entities.Implement.DomainBlob", b =>
                {
                    ...
                    b.ToTable("DomainBlob", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Implement.Aggregates.Identity_KyC.Document", b =>
                {
                    b.HasOne("Domain.Entities.Implement.DomainBlob", "BackImage")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Implement.Aggregates.Identity_KyC.Document", "BackImageId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Domain.Entities.Implement.DomainBlob", "FrontImage")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Implement.Aggregates.Identity_KyC.Document", "FrontImageId")
                        .OnDelete(DeleteBehavior.NoAction);
